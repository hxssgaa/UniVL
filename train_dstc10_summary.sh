...
DATA_PATH="data/dstc10/dstc10_data_all.caption.pickle"
VIDEO_FEATURES_PATH="data/dstc10/dstc10_videos_features_all.pickle"
AUDIO_FEATURES_PATH="data/dstc10/dstc10_changhuai_audio_features_all.pickle"
...
python -m torch.distributed.launch --nproc_per_node=2 \
	...
	--output_dir ${OUTPUT_ROOT}/ckpt_charades_gen_caption --bert_model bert-base-uncased \
	--do_lower_case --lr 3e-5 --max_words 256 --max_frames 60 \
	--batch_size_val 64 --visual_num_hidden_layers 6 \
	--decoder_num_hidden_layers 3 --video_dim 1024 --audio_dim 200 --stage_two \

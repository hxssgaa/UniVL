...
FEATURES_PATH="data/atis/atis_asr_new_features.pickle"
INIT_MODEL="weight/univl.pretrained.bin"
INIT_MODEL="ckpts/ckpt_youcook_caption/pytorch_model.bin.9"
OUTPUT_ROOT="ckpts"
...
python -m torch.distributed.launch --nproc_per_node=2 \
	...
	--val_csv ${VAL_CSV} \
	--data_path ${DATA_PATH} \
	--video_features_path ${FEATURES_PATH} \
	...
	--decoder_num_hidden_layers 3 --video_dim 768 --stage_two --skip_audio \
